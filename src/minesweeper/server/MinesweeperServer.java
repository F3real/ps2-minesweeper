...
public class MinesweeperServer {
	...
	/** Board for online minesweeper. */
	private static Board minesweeperBoard;
	...
	public void serve() throws IOException {
		while (true) {
			...
			// handle the client
			MinesweeperServerThread clientHandler = new MinesweeperServerThread(socket, minesweeperBoard, debug);
			clientHandler.start();
		}
	}
	...
	public static void runMinesweeperServer(boolean debug, Optional<File> file, int sizeX, int sizeY, int port)
		...
		if (file.isPresent()) {
			MinesweeperServer.minesweeperBoard = new Board(file.get());
		} else {
			MinesweeperServer.minesweeperBoard = new Board(sizeX, sizeY);
		}
